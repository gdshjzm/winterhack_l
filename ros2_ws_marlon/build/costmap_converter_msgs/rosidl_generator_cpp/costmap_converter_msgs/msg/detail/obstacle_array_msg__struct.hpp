...
struct ObstacleArrayMsg_
{
  ...
  using _obstacles_type =
    std::vector<costmap_converter_msgs::msg::ObstacleMsg_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<costmap_converter_msgs::msg::ObstacleMsg_<ContainerAllocator>>>;
  ...
  Type & set__obstacles(
    const std::vector<costmap_converter_msgs::msg::ObstacleMsg_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<costmap_converter_msgs::msg::ObstacleMsg_<ContainerAllocator>>> & _arg)
  {
    this->obstacles = _arg;
    return *this;
  }
