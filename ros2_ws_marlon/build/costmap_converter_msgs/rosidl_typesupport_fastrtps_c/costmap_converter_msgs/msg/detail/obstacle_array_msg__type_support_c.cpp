...
#include "costmap_converter_msgs/msg/detail/obstacle_array_msg__rosidl_typesupport_fastrtps_c.h"
...
using _ObstacleArrayMsg__ros_msg_type = costmap_converter_msgs__msg__ObstacleArrayMsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObstacleArrayMsg__ros_msg_type * ros_message = static_cast<const _ObstacleArrayMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: obstacles
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, costmap_converter_msgs, msg, ObstacleMsg
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _ObstacleArrayMsg__ros_msg_type * ros_message = static_cast<_ObstacleArrayMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: obstacles
  {
    ...
    if (ros_message->obstacles.data) {
      costmap_converter_msgs__msg__ObstacleMsg__Sequence__fini(&ros_message->obstacles);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_costmap_converter_msgs__msg__ObstacleMsg(
  ...
  size_t current_alignment)
{
  ...
  // member: obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_costmap_converter_msgs__msg__ObstacleMsg(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = costmap_converter_msgs__msg__ObstacleArrayMsg;
    is_plain =
      (
...
static size_t _ObstacleArrayMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_costmap_converter_msgs__msg__ObstacleArrayMsg(
