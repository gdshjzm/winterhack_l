...
static const _TrajectoryMsg_type_support_symbol_names_t _TrajectoryMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teb_msgs, msg, TrajectoryMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teb_msgs, msg, TrajectoryMsg)),
  }
};
...
{
  return &::teb_msgs::msg::rosidl_typesupport_cpp::TrajectoryMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, teb_msgs, msg, TrajectoryMsg)() {
  return get_message_type_support_handle<teb_msgs::msg::TrajectoryMsg>();
}
