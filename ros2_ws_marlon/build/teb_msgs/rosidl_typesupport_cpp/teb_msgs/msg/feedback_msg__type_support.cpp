...
static const _FeedbackMsg_type_support_symbol_names_t _FeedbackMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teb_msgs, msg, FeedbackMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teb_msgs, msg, FeedbackMsg)),
  }
};
...
{
  return &::teb_msgs::msg::rosidl_typesupport_cpp::FeedbackMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, teb_msgs, msg, FeedbackMsg)() {
  return get_message_type_support_handle<teb_msgs::msg::FeedbackMsg>();
}
