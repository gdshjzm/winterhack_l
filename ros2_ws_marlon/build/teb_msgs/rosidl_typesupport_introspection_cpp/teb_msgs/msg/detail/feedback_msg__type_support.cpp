...
void fetch_function__FeedbackMsg__trajectories(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const teb_msgs::msg::TrajectoryMsg *>(
    get_const_function__FeedbackMsg__trajectories(untyped_member, index));
  auto & value = *reinterpret_cast<teb_msgs::msg::TrajectoryMsg *>(untyped_value);
  value = item;
}

void assign_function__FeedbackMsg__trajectories(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<teb_msgs::msg::TrajectoryMsg *>(
    get_function__FeedbackMsg__trajectories(untyped_member, index));
  const auto & value = *reinterpret_cast<const teb_msgs::msg::TrajectoryMsg *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FeedbackMsg_message_member_array[4] = {
  ...
  },
  {
    ...
    fetch_function__FeedbackMsg__trajectories,  // fetch(index, &value) function pointer
    assign_function__FeedbackMsg__trajectories,  // assign(index, value) function pointer
