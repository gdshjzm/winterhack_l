...
set(_exported_dependencies "costmap_converter;dwb_critics;nav_2d_utils;nav2_core;nav2_costmap_2d;nav2_util;geometry_msgs;nav_msgs;rclcpp;rclcpp_action;rclcpp_lifecycle;std_msgs;pluginlib;teb_msgs;tf2;tf2_eigen;tf2_geometry_msgs;tf2_ros;visualization_msgs;builtin_interfaces")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to teb_local_planner_DEFINITIONS, teb_local_planner_INCLUDE_DIRS,
# teb_local_planner_LIBRARIES, and teb_local_planner_LINK_FLAGS.
# Additionally collect the direct dependency names in
# teb_local_planner_DEPENDENCIES as well as the recursive dependency names
# in teb_local_planner_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(teb_local_planner_DEPENDENCIES ${_exported_dependencies})
  set(teb_local_planner_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(teb_local_planner_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(teb_local_planner_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(teb_local_planner_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(teb_local_planner_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(teb_local_planner_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND teb_local_planner_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
