...
bool costmap_converter_msgs__msg__obstacle_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("costmap_converter_msgs.msg._obstacle_msg.ObstacleMsg", full_classname_dest, 52) == 0);
  }
  costmap_converter_msgs__msg__ObstacleMsg * ros_message = _ros_message;
  {  // header
  ...
  {  // velocities
    ...
    if (!geometry_msgs__msg__twist_with_covariance__convert_from_py(field, &ros_message->velocities)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * costmap_converter_msgs__msg__obstacle_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("costmap_converter_msgs.msg._obstacle_msg");
  ...
  {  // velocities
    PyObject * field = NULL;
    field = geometry_msgs__msg__twist_with_covariance__convert_to_py(&ros_message->velocities);
    if (!field) {
      return NULL;
    }
    {
