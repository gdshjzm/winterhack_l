...
void fetch_function__ObstacleArrayMsg__obstacles(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const costmap_converter_msgs::msg::ObstacleMsg *>(
    get_const_function__ObstacleArrayMsg__obstacles(untyped_member, index));
  auto & value = *reinterpret_cast<costmap_converter_msgs::msg::ObstacleMsg *>(untyped_value);
  value = item;
}

void assign_function__ObstacleArrayMsg__obstacles(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<costmap_converter_msgs::msg::ObstacleMsg *>(
    get_function__ObstacleArrayMsg__obstacles(untyped_member, index));
  const auto & value = *reinterpret_cast<const costmap_converter_msgs::msg::ObstacleMsg *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObstacleArrayMsg_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__ObstacleArrayMsg__obstacles,  // fetch(index, &value) function pointer
    assign_function__ObstacleArrayMsg__obstacles,  // assign(index, value) function pointer
