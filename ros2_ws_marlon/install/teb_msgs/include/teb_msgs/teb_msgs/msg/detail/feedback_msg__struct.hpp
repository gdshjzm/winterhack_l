...
struct FeedbackMsg_
{
  ...
  using _trajectories_type =
    std::vector<teb_msgs::msg::TrajectoryMsg_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<teb_msgs::msg::TrajectoryMsg_<ContainerAllocator>>>;
  ...
  Type & set__trajectories(
    const std::vector<teb_msgs::msg::TrajectoryMsg_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<teb_msgs::msg::TrajectoryMsg_<ContainerAllocator>>> & _arg)
  {
