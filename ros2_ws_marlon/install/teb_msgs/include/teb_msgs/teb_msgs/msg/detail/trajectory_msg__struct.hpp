...
struct TrajectoryMsg_
{
  ...
  using _trajectory_type =
    std::vector<teb_msgs::msg::TrajectoryPointMsg_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<teb_msgs::msg::TrajectoryPointMsg_<ContainerAllocator>>>;
  ...
  Type & set__trajectory(
    const std::vector<teb_msgs::msg::TrajectoryPointMsg_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<teb_msgs::msg::TrajectoryPointMsg_<ContainerAllocator>>> & _arg)
  {
