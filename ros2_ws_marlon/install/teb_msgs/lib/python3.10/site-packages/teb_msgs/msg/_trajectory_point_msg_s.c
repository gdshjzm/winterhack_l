...
bool teb_msgs__msg__trajectory_point_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("teb_msgs.msg._trajectory_point_msg.TrajectoryPointMsg", full_classname_dest, 53) == 0);
  }
  teb_msgs__msg__TrajectoryPointMsg * ros_message = _ros_message;
  {  // pose
...
{
  /* NOTE(esteve): Call constructor of TrajectoryPointMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("teb_msgs.msg._trajectory_point_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrajectoryPointMsg");
