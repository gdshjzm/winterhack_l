...
def launch_setup(context):
    ...
    machine_type = LaunchConfiguration('machine_type', default='LanderPi_Mecanum').perform(context)
    ...
    machine_type_env = SetEnvironmentVariable('MACHINE_TYPE', machine_type)
