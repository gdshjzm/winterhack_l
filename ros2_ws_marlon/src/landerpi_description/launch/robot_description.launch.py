...
def generate_launch_description():
    ...
    if compiled == 'True':
        ...
        landerpi_description_package_path = '/home/ubuntu/ros2_ws/src/simulations/landerpi_description'
    urdf_path = os.path.join(landerpi_description_package_path, 'urdf/landerpi.xacro')
    rviz_config_file = os.path.join(landerpi_description_package_path, 'rviz/view.rviz')
    ...
    rviz_launch = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(landerpi_description_package_path, 'launch', 'rviz.launch.py')),
