...
def launch_setup(context):
    ...
    declare_cmd_vel_out_cmd = DeclareLaunchArgument(
        'cmd_vel_out',
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(winterhack_dir, 'config', 'nav2_params_exploration.yaml'),
    ...
    map_arg = DeclareLaunchArgument(
        'map',
        default_value=PathJoinSubstitution([winterhack_dir, 'maps', 'map_01.yaml']))
    ...
    load_nodes = GroupAction(
        ...
        actions=[
            ...
            Node(
                ...
                arguments=['--ros-args', '--log-level', log_level],
                remappings=remappings +
                        [('cmd_vel', 'cmd_vel_nav'), ('cmd_vel_smoothed', cmd_vel_out)]),
            Node(
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                PathJoinSubstitution(
                    [winterhack_dir, 'launch', 'localization.launch.py'])),
